...
export default async function () {
	...
	if (!release) {
		throw new Error('No release found in the last 31 days');
	}
	...
	return {
		version: `${version}-${date.toString().replaceAll('-', '')}`,
		urls,
	};
}
